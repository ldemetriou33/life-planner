      ...
      >
        ...
        {isOpen && (
          <motion.div
            ...
            className="mt-4 backdrop-blur-xl bg-white/90 border border-gray-200 rounded-lg p-6"
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4 mb-4">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="flex items-center justify-center gap-2 py-3 px-4 bg-[#0077b5] text-white rounded-lg font-medium hover:bg-[#006399] transition-colors"
              >
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="flex items-center justify-center gap-2 py-3 px-4 bg-[#1DA1F2] text-white rounded-lg font-medium hover:bg-[#1a8cd8] transition-colors"
              >
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="flex items-center justify-center gap-2 py-3 px-4 bg-gray-700 text-white rounded-lg font-medium hover:bg-gray-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isGenerating ? (
                  <>
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="flex items-center justify-center gap-2 py-3 px-4 bg-gray-700 text-white rounded-lg font-medium hover:bg-gray-600 transition-colors"
              >
                {copied ? (
                  <>
