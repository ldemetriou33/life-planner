...
export default function HumanMoatIndicator({ level }: HumanMoatIndicatorProps) {
  ...
  return (
    <motion.div
      ...
      className="backdrop-blur-xl bg-black/50 border border-white/10 rounded-lg p-6 relative"
          ...
          <AnimatePresence>
            {showTooltip && (
              <motion.div
                ...
                className="absolute right-0 top-full mt-2 w-80 p-4 bg-black/95 border border-white/20 rounded-lg shadow-xl z-50 pointer-events-none"
              >
                <p className="text-sm text-gray-300 leading-relaxed">
                  <strong className="text-white">Moravec's Paradox:</strong> AI excels at logic, mathematics, and pattern recognition, but struggles with physical dexterity, emotional empathy, and chaotic real-world agency. Your human moat represents how protected your career is from AI automation based on these principles.
                </p>
              </motion.div>
            )}
          </AnimatePresence>
